            ...
            success: function (response) {
                ...
                if (response.quantity <= 0) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                        text: 'This payment link is no longer valid!',
                        html:
                            'his payment link is no longer valid! <br/><br/>' +
                            '<a href="//sweetalert2.github.io">Kindly contact person who gave you this link to issue another one to you.</a> ',
                        confirmButtonText: 'Okay',
                        confirmButtonColor: '#6da445'
...
var BuyerInfoStep = function (dealId) {
    ...
    self.command = {
        ...
        items: ko.observableArray([]).subscribeTo('transactionItems')
    };
}
